...
// TODO Auto-generated method stub
		String filename;
		char ch;
		File directory = new File("E://Nandi documents");
...
// Take user Option from the below mentioned Menu
		...
		System.out.println("*****************************************");
		System.out.println("******* NANDEESH B R *********************");
		System.out.println("*****************************************");
		...
		do {
			...
			case 1:
				...
				filename = input.next();
				try {
					File file = new File("E://Nandi documents//" + filename + ".txt");
...
// TODO Auto-generated catch block
			...
			case 3:
				...
				filename = input.next();
				File directory_delete = new File("E://Nandi documents//");
...
// Linear search in the array
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							File file = new File(
									"E://Nandi documents//" + delete_filename);
							if (file.delete()) {
...
// Replace the file path with path of the directory
				...
				filename = input.next();
				File directory_search = new File("E://Nandi documents//");
...
// TODO Auto-generated method stub
		...
		File folder = new File("E://Nandi documents//");
